...
test.describe("Dropdown Flow", () => {
    test("Dropdown Flow", async ({ page, menusPage, dropdownPage }) => {
        ...
        await test.step("Single Select Option", async () => {
            ...
            await expect(dropdownPage.singleDropdownResult).toHaveText('You selected: Apple');
            ...
            await expect(dropdownPage.singleDropdownResult).toHaveText('You selected: Banana');
            ...
            await expect(dropdownPage.singleDropdownResult).toHaveText('You selected: Mango');
            ...
            await expect(dropdownPage.singleDropdownResult).toHaveText('You selected: Orange');
            await expect(dropdownPage.singleSelectDropdown).toHaveValue('Orange');
        })

        await test.step("Multi Selection Option", async () => {
            await dropdownPage.multipleDropdownSelect.selectOption(['India', 'USA', 'UK', 'Canada', 'Australia']);
            await expect(dropdownPage.multipleDropdownSelect).toHaveValues(['India', 'USA', 'UK', 'Canada', 'Australia']);
        })
