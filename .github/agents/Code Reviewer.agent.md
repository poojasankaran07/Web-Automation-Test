...
tools: [read, search]
user-invocable: true
reference_files: [".github/automation/review/CODE_REVIEW.md", ".github/automation/skills/playwright-ui.instructions.md", ".github/automation/skills/playwright-generic.instructions.md"]
---
